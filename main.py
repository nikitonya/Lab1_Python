...
directory_to_extract_to = 'C:\\Users\\nikit\\Desktop\\Учёба\\5 семестр\\Прикладное программирование (Python)\\unpacking'  # директория извлечения файлов архива
arch_file = "C:\\Users\\nikit\\Desktop\\Учёба\\5 семестр\\Прикладное программирование (Python)\\tiff-4.2.0_lab1.zip"  # путь к архиву
